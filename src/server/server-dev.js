...
var webpack_dev_config_js_1 = __importDefault(require("../../webpack.dev.config.js"));
var app = express_1.default(), DIST_DIR = __dirname, HTML_FILE = path_1.default.join(DIST_DIR, 'index.html'), compiler = webpack_1.default(webpack_dev_config_js_1.default);
